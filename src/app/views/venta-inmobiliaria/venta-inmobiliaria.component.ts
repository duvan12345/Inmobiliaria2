...
@Component({
  selector: 'app-venta-inmobiliaria',
  templateUrl: './venta-inmobiliaria.component.html',
  styleUrl: './venta-inmobiliaria.component.scss'
})


export class VentaInmobiliariaComponent  implements OnInit{
 ...
 this.refreshIncident(); 
  ...
  refreshIncident() {
    ...
    //   //  console.log(this.ListIncidents)
      ...
      this.ListIncidentsPagination = this.ListaVenta.map((Country, i) => ({ ...Country })).slice(
